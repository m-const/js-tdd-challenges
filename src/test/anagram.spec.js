...
describe("anagram() unit tests", () => {
  describe("Happy Path", () => {
    ...
    it(`Happy Path - Str: Should return an object with a target property of type string`, () => {
      assert.isString(
        res.target,
        "Happy Path target property returned not a string"
      );
    });
    it(`Happy Path - Str: Should return an object with an anagram property of type array`, () => {
      assert.isArray(
        res.anagram,
        "Happy Path anagram property returned not an array"
      );
    });
    it(`Happy Path - Str: Should return an object with an anagram property of type array with first element equal to ${hpSearch}`, () => {
      assert.equal(
        res.anagram[0],
        hpSearch,
        `Happy Path anagram property element 1 returned other than "${hpSearch}"`
      );
    });
  });

  describe("Happy Path - Arrays", () => {
    ...
    it(`Happy Path - Array: Should return an object with an anagram property of type array with first element equal to ${hpArrSearch[0]}`, () => {
      assert.equal(
        resHpArr.anagram[0],
        hpArrSearch[0],
        `Happy Path anagram property element 1 returned other than "${hpArrSearch[0]}"`
      );
    });
  });
  describe("Negative Path - Array", () => {
    //Negative - Array
    ...
    it(`Negative Path - Array: Should return an object with a target property of type string`, () => {
      assert.isString(
        negArrRes.target,
        "Negative Path target property returned not a string"
      );
    });
    it(`Negative Path - Array: Should return an object with an anagram property of type null`, () => {
      assert.isNull(
        negArrRes.anagram,
        "Negative anagram property returned not null"
      );
    });
  });
  describe("Negative Path - String", () => {
    //Negative - STR
  ...
  describe("Edge Cases", () => {
    ...
    it(`Edge Case 3 - empty search array: Should return null`, () => {
      assert.isNull(
        ec3Res.anagram,
        "Empty search array target returned not null"
      );
    });
    ...
    it(`Edge Case 6 - Search array contains a non-string element but containing a string anagram: Should return the valid anagram in valid object`, () => {
      assert.equal(
        ec6Res.anagram[0],
        ec6Search[0],
        "Search array containing a non-string element but containing a string anagram returned not valid return object"
      );
    });
